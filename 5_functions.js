...
// function greet() {
//   console.log("Hello Guys, Welcome to dev Technical JS Course ");
// }
...
//! Write a JavaScript program that defines a function called greet to welcome individuals to the dev Technical JS Course. The function should take a name parameter and output the message "Hello [name], Welcome to dev Technical JS Course". Call the function twice, once with the argument "abbas" and once with the argument "ram".
// function greet(name) {
//   console.log("Hello " + name + ", Welcome to dev Technical JS Course");
// }
...
console.log(isReverse("abbas dev"));
