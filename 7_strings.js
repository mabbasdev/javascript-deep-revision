...
// let text = "My name is " dev Technical " & I am a Full Stack Developer. ";
// let text =
//   "My name is ' dev Technical ' & \\ I am a \"Full Stack \" Developer. ";
// // let text = 'My name is " dev Technical " & I am a Full Stack Developer. ';
...
// let result = text.substring(1);
//? Optional
// let result = text.replace("JavaScript", "abbas");
// let result = text.replaceAll("JavaScript", "abbas");
...
// let replacedString = originalString.replace(/world/gi, "abbas");
...
//   return count;
// };
//   console.log(checkAllVowelPresentOrNot("my name u is abbas @  dev"));
